...
const createMyStore = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const body = yield (0, validate_1.validateSchema)(store_validation_1.createStoreSchema, Object.assign(Object.assign({}, req.body), { avatar: req.file }));
...
const updateMyStore = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const body = yield (0, validate_1.validateSchema)(store_validation_1.updateStoreSchema, Object.assign(Object.assign({}, req.body), { avatar: req.file }));
